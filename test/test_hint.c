...
static int all_unique(struct capture_hint *hints, int count) {
  int i, j;
...
static int no_prefix(struct capture_hint *hints, int count) {
  int i, j;
  size_t len_i;
...
static int max_len(struct capture_hint *hints, int count) {
  int i, m = 0;
